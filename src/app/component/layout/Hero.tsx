  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 sm:py-32">
      <div className="absolute inset-0 opacity-10 pointer-events-none z-0">
        {/* <div className="w-full h-full grid grid-cols-10 grid-rows-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-lg font-semibold w-[200px] md:w-[250px]">
              <Link href="/mail"> Join the Waitlist</Link>{" "}
            </Button>
            <Button className="px-8 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white  w-[200px] md:w-[250px]">
              Learn More
            </Button>
          </div>
          {/* <WaitlistForm/> */}
